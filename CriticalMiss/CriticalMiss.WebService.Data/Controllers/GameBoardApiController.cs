...
namespace CriticalMiss.WebService.Data.Controllers
{
    ...
    public class GameBoardApiController : Controller
    {
        ...
        [HttpPut("{BoardName}")]
        public IActionResult UpdateGame([FromRoute] string boardname, [FromBody] Boards gameboard)
        {

            var upboardgames = _context.GameBoard.SingleOrDefault(x => x.BoardName == boardname);
